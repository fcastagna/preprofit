...
def int_func_1(r, pp, sza, szf, szc, szl, szs, dm, output):
    ...
    '''
    # abel transform
    ab = calc_abel(pp, r=r, abel_data=sza)#[calc_abel(pp[i], r=r[i], abel_data=sz.abel_data[i]) for i in range(len(r))]
    # Compton parameter
...
@as_op(itypes=[tt.dvector, tt.dvector, Generic()], otypes=[tt.dvector])
